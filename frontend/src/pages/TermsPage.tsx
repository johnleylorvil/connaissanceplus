        ...
        <div style={{ display: 'grid', gap: 24 }}>
          <section>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-3)', lineHeight: 1.8 }}>
              La plateforme est destinée en priorité aux élèves et aux encadrants autorisés. Chaque utilisateur s’engage à fournir des informations exactes lors de l’inscription et à préserver la confidentialité de son compte.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-3)', lineHeight: 1.8 }}>
              Les classements, podiums et récompenses sont publiés selon les règles affichées sur la plateforme. Konesans+ peut ajuster un résultat en cas d’erreur technique, d’abus ou de non-respect du règlement.
            </p>
          </section>
          <section>
            <h2 style={{ fontSize: 18, color: 'var(--cobalt)', marginBottom: 8 }}>4. Évolution du service</h2>
            <p style={{ fontSize: 14, color: 'var(--ink-3)', lineHeight: 1.8 }}>
              La plateforme peut évoluer pour améliorer l’expérience, renforcer la sécurité ou préciser les règles de compétition. Toute évolution importante sera reflétée dans les informations publiées sur Konesans+.
            </p>
          </section>
        </div>
      </div>
